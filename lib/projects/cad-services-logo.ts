...
export const project: Project = {
  ...
  content: "Created a logo for a new CAD services team that specializes in creating detailed 3D models and drawings for manufacturing companies. The logo needed to convey precision, technical expertise, and professionalism.\n\nWeb Presence:\nIn addition to the logo, I developed a comprehensive web presence for the CAD Services team. The website showcases their expertise, featuring detailed information about their services and a portfolio of their work.\n\nVisit the site: [CAD Services Website](https://www.apontedesign.com)",

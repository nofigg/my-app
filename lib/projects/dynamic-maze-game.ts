...
export const project: Project = {
  ...
  challenges: [
    ...
    "Creating an engaging rainbow trail effect that follows the player",
    "Designing a clean, modern UI with a purple theme",
    "Building a persistent high score system with dates",
    "Optimizing game performance for smooth animations"
  ],
  outcomes: [
    "Created an intuitive maze game with simple arrow key controls",
    "Implemented a high score system tracking top 5 scores and dates",
    "Designed an appealing visual style with a rocket and rainbow trail",
    "Built the game using modern web development tools",
    "Successfully deployed on both Stackblitz and Bolt.new platforms"
  ]
}
